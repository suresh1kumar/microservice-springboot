...
<span id="more-details">S/W Developer<i class="ti-angle-down"></i></span>
</div>
</div>
<div class="main-menu-content">
<ul>
<li class="more-details">
<a href="getUserProfile"><i class="ti-user"></i>View Profile</a>
...
<ul class="pcoded-submenu">
<li class="">
<a href="getStudentModalForm" data-i18n="nav.user-profile.timeline">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
...
<ul class="pcoded-submenu">
<li class="">
<a href="getGalleryGrid" data-i18n="nav.gallery.gallery-grid">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
...
<li class="">
<a href="getGalleryMasonry" data-i18n="nav.gallery.masonry-gallery">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
...
<li class="">
<a href="getGalleryAdvance" data-i18n="nav.gallery.advance-gallery">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
...
<ul class="pcoded-submenu">
<li class="">
<a href="getEventFullCalender" data-i18n="nav.full-calendar.full-calendar">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
...
<li class="">
<a href="geTeventClndr" data-i18n="nav.clnder.clnder">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
