  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-globe"></i> Suresh Kumar Gupta, Inc.
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        ...
        <address>
          ...
          Phone: (+91) 7670852491<br>
          Email: suresh.kumar8409@gmail.com
        </address>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        ...
        <img src="cdn/dist/img/credit/visa.png" alt="Visa">
        <img src="cdn/dist/img/credit/mastercard.png" alt="Mastercard">
        <img src="cdn/dist/img/credit/american-express.png" alt="American Express">
        <img src="cdn/dist/img/credit/paypal2.png" alt="Paypal">
