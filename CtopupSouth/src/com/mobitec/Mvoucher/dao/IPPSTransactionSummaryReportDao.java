...
public interface IPPSTransactionSummaryReportDao {
	
	public List<PPSTransactionSummaryReportBean> getAllPPSTransactionSummaryReport(String strFromDate,String strToDate);;
