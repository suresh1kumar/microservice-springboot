...
<body>
	<h1>Reports>>Circle IN Denomination wise Sales Report  </h1>
						<div class="main">
									<div class="facts">
														...
														<div class="reservation">
															       <ul>	
																	 <li  class="span1_of_1">
																		 ...
																		 <div class="section_dest">
																			  <select class="custom-select" id="select-4">
																								<option selected="selected">Circle Name</option>
																								<option>1</option>
																								<option>2</option>
																								<option>3</option>
																								<option>4</option>
																	 ...
																	 <li  class="span1_of_1 left">
																		 ...
																		 <div class="section_dest">
																			<select class="custom-select" id="select-4">
																								<option selected="selected">IN Name</option>
																								<option>1</option>
																								<option>2</option>
																								<option>3</option>
																								<option>4</option>
   		...
   		<div class="copy-right">
   			<div class="wrap">
				<p>&copy; 2018 Reports>>Circle IN Denomination wise Sales Report   | By Pyro </p>
		</div>
	</div>
	<!--//end-copyright-->
</body>
