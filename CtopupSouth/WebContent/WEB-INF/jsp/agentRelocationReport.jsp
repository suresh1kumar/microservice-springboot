...
<body>
<div class="container " >
			<h5 style="margin-bottom: 20px">Agent Relocation Report >>></h5>
...
<br><br><br>
	                ...
	                <table id="employees" cellspacing="0" width="100%" style=" ">
						<thead>
					    	<tr>
			                    ...
			                    <td>Agent Name</td>
			                    <td>Agent Msisdn</td>
			                    <td>Category Before</td>
			                    <td>Category After</td>
			                    <td>Current Parent</td>
			                    <td>Current Top Level</td>
			                    <td>Previous Parent</td>
			                    <td>Previous Top Level</td>
			                    <td>Date</td>
					    	</tr>
						</thead>
					</table>
	   ...
	   /*  {
	    	"c_FULLNAME":"Nalgonda",
	    	"first_NAME":"Balaji Reddy",
	    	"authorised_MOBILE_NUMBER":"7207288557",
	    	"category_BEF":"REG",
	    	"category_AFT":"REG",
	    	"ref_ID_AFT":"9494947388",
	    	"ref_ID_BEF":"9700390208",
	    	"mas_ID_AFT":"TESTm",
	    	"mas_ID_BEF":"Suresh kumar",
	    	"insert_DATE":"2017-12-28"
	    	} */
	function submitForm() {
		...
		console.log(msisdn + "~" + fromDate + "~" + toDate);
		alert(msisdn + "~" + fromDate + "~" + toDate);
		console.log("isValid :: " + isValid);
		alert("isvalied111 ::" + isValid);
		if (isValid) {
			$.ajax({
				url : 'get-all-agentRelocationReport',
				type : 'POST',
				dataType : 'json',
				crossDomain : true,
