...
<title>Unified Sim Sales Report</title>
		<meta charset="utf-8">
...
<body>
<div class="container " >
			<h5 style="margin-bottom: 20px">Reports >> Unified Sim Sales Report >>></h5>
							...
							<select id="status" name="status" >
			                    <option value='-1'>All</option>
			                     <option value='U'>Used</option>
			                      <option value='P'>Available</option>
			                </select>
						</div>
						<div class="col-sm-6">
							<select id="searchBy" name="searchBy" >
			                    <option value='INS_DATE'>Inserted Date</option>
			                     <option value='UPD_DATE'>Updated Date</option>
			                </select>
						</div>
					</div>
				</fieldset>	
	...
	function submitForm() {
		...
		console.log(status + "~" + searchBy + "~" + msisdn + "~" + fromDate + "~" + toDate);
		alert(status + "~" + searchBy + "~" + msisdn + "~" + fromDate + "~" + toDate);
		console.log("isValid :: " + isValid);
		alert("isvalied111 ::" + isValid);
		if (isValid) {
			$.ajax({
				url : 'get-all-unifiedSimSalesReport',
				type : 'POST',
				dataType : 'json',
				crossDomain : true,
