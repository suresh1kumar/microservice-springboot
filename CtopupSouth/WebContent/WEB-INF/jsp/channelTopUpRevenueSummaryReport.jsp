...
<title>Channel TopUp Revenue Summary Report</title>
		<meta charset="utf-8">
...
<body>
<div class="container " >
			<h5 style="margin-bottom: 20px">Reports>>Channel TopUp Revenue Summary >>></h5>
				...
				<div id="applications" style="padding-top: 15px; display: none; "></div>
	                <table id="employees" cellspacing="0" width="100%" style=" ">
						<thead>
					    	<tr>
					            <td>Date</td>
			                    <td>No._of_Active_Franchises</td>
			                    <td>No._of_Used_Franchises</td>
			                    <td>Stock_Allocation_In_Rs.</td>
			                    <td>Recharge_Quantity</td>
			                    <td>Recharge_Amount_In_Rs.</td>
			                    <td>Topup_Quantity</td>
			                    <td>Topup_Amount_In_Rs.</td>
			                    <td>No._of_Movements</td>
			                    <td>Total_Movements_Amount_In_Rs.</td>
					    	</tr>
						</thead>
					</table>
 	</div>
 	 ...
 	 <script type="text/javascript">
		...
		table = $("#employees").DataTable({ 
			...
			"columns" : [ {
				...
				data : "number_OF_DEALERS"
			}, {
				data : "used_DEALER"
			}, {
				data : "allocations"
			}, {
				data : "recharge_QUANTITY"
			}, {
			...
			buttons: [
	            {
	                extend: 'excelHtml5',
	                title: 'ChannelTopUpRevenueSummaryReport'
	            },
	            {
	                extend: 'csvHtml5',
	                title: 'ChannelTopUpRevenueSummaryReport'
	...
	function submitForm() {
		...
		if (isValid) {
			$.ajax({
				url : 'get-all-channelTopUpRevenueSummary',
				type : 'POST',
				dataType : 'json',
				crossDomain : true,
