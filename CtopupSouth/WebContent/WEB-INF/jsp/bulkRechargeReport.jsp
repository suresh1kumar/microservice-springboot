...
<title>Bulk Recharge Report</title>
		<meta charset="utf-8">
...
<body>
<div class="container " >
			<h5 style="margin-bottom: 20px">Bulk Recharge Report >>></h5>
			
			<fieldset class="well">
	    			<legend class="well-legend" style="padding-top: 2px">By Area</legend>
					<div class="row">
					<div class="col-sm-6">
						 <select name="course" id="course" style="width: 158px;">
				            <option>All</option>
						...
						<div class="col-sm-6">
							 <input type="text" class="form-control" id="smsisdn" NAME="smsisdn" value="" placeholder="input dealerid & mobile">
						</div>
					</div>
				</fieldset>	
				<fieldset class="well">
...
<script type="text/javascript">
	...
	function submitForm() {
		...
		console.log(course + "~" + smsisdn + "~" + fromDate + "~" + toDate);
		alert(course + "~" + smsisdn + "~" + fromDate + "~" + toDate);
		console.log("isValid :: " + isValid);
		alert("isvalied111 ::" + isValid);
		if (isValid) {
			$.ajax({
				url : 'get-all-bulkRechargeReport',
				type : 'POST',
				dataType : 'json',
				crossDomain : true,
