...
<title> Retailer Bonanza Report</title>
		<meta charset="utf-8">
...
<body>
<div class="container " >
			<h5 style="margin-bottom: 20px"> Retailer Bonanza Report >>></h5>
			<input type="hidden" id="circlehidden" name="circlehidden" value="">
 	        ...
 	        <fieldset class="well">
				...
				<fieldset class="well">
					...
					<div class="row">
					<div class="col-sm-6">
							<SELECT  id="status"  name=status><!-- style="WIDTH: 102px;" class="sm-mag-nrm" -->
				...
				<div id="applications" style="padding-top: 15px; display: none; "></div>
	                <table id="employees" cellspacing="0" width="100%" style=" ">
						<thead>
					    	<tr>                             <!-- AMOUNT,STATUS,ALLOCATED_USER,APPROVED_USER,ALLOCATED_DATE,APPROVED_DATE  -->
					            <td>AMOUNT</td>
			                    <td>STATUS</td>
			                    <td>ALLOCATED_USER</td>
			                    <td>APPROVED_USER</td>
 ...
 <script type="text/javascript">
	...
	function submitForm() {
		...
		console.log(region + "~" + city + "~" + status + "~" + mobile  + "~" + fromDate + "~" + toDate);
		alert(region + "~" + city + "~" + status + "~" + mobile  + "~" + fromDate + "~" + toDate);
		console.log("isValid :: " + isValid);
		alert("isvalied111 ::" + isValid);
		if (isValid) {
			$.ajax({
				url : 'get-all-retailerBonanzaReport',
				type : 'POST',
				dataType : 'json',
				crossDomain : true,
