...
<body>
<form class="modal-content animate" action="addPersonalDetails">
		<div class="container">
		<label>First Name:</label>
		<input type="text" name="txtfname" placeholder="First Name"/>
		
		<label>Last Name:</label>
		<input type="text" name="txtlname" placeholder="Last Name"/>
				
		<label>Father Name:</label>
		<input type="text" name="txtfathername" placeholder="Ftaher Name"/>
			
		<label>Mother Name:</label>
		<input type="text" name="txtmothername" placeholder="Mother Name"/>
				
		<label>Date Of Birth:</label>
		<input type="text" name="txtdob" placeholder="DOB" id="datepicker"/>
		...
		<input type="text" name="txtpincode" placeholder="Pin Code" />
	
		<label>Address:</label>
		<input type="text" name="txtaddr" placeholder="Address" />
