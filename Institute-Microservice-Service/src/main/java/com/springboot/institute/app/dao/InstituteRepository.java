...
import com.springboot.institute.app.repo.InstituteDto;
...
public interface InstituteRepository extends JpaRepository<Institute, Long> {
    ...
    @Query("SELECT new com.springboot.institute.app.model.Institute(i.instituteId, i.name)  FROM Institute  AS i ")
