package com.pyro.software.reporter.restservices;
...
import com.pyro.software.reporter.reportmgmt.Element;
import com.pyro.software.reporter.reportmgmt.Report;
import com.pyro.software.reporter.reportmgmt.ReportManager;
import com.pyro.software.reporter.reportmgmt.RowElement;
...
public class ReportManagementService {
	...
	@Path("/{userName}/{reportName}/{elementName}/{zoneId}/{circleId}/{cityId}/")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
 			...
 			for (RowElement rowElement : reportElements) {
 				...
 				for (Element element : elements) {
 					if(element.getTitle().equalsIgnoreCase(elementName)){
 						try {
 							element.setElements(zoneId, circleId, cityId);
 							element.init();
 						} catch (Exception e) {
 							e.printStackTrace();
